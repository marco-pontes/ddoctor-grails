...
security {
	...
	userLookup.userDomainClassName = 'Usuario'
	userLookup.usernamePropertyName = 'login'
	userLookup.enabledPropertyName = 'ativo'
	userLookup.passwordPropertyName = 'senha'
	userLookup.authoritiesPropertyName = 'authorities'
	userLookup.accountExpiredPropertyName = 'contaExpirada'
	userLookup.accountLockedPropertyName = 'contaBloqueada'
	userLookup.passwordExpiredPropertyName = 'senhaExpirada'
	userLookup.userDomainClassName = 'ddoctor.usuario.Usuario'
	userLookup.authorityJoinClassName = 'ddoctor.usuario.UsuarioPerfil'
	authority.className = 'ddoctor.usuario.Perfil'
	...
	// successHandler
	successHandler.defaultTargetUrl = '/dashboard/index'
